...
ctx.json(getPostPublicationMock()),
        ...
        return res(
          ctx.delay(1000),
          ctx.status(200, 'Mocked status'),
ctx.json(getGetPublicationMock()),
        )
