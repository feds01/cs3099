...
export const getDeletePublicationUsernameNameRevisionMock = () => ({
    status: faker.helpers.randomize(['ok']),
    message: faker.random.word(),
});

export const getGetPublicationUsernameNameRevisionMock = () => ({
    status: faker.helpers.randomize(['ok']),
    publication: {
        id: faker.random.word(),
        name: faker.random.word(),
...
export const getGetPublicationUsernameNameRevisionAllMock = () => ({
    status: faker.helpers.randomize(['ok']),
    files: [...Array(faker.datatype.number({ min: 1, max: 10 }))].map(() => ({
        type: faker.helpers.randomize(['file']),
        filename: faker.helpers.randomize([faker.random.word(), undefined]),
        contents: faker.random.word(),
        updatedAt: faker.datatype.number(),
