...
export const getPostPublicationUsernameNameExportMock = () => ({status: faker.helpers.randomize(['ik']), message: faker.random.word(), extra: faker.helpers.randomize([{}, undefined])})
