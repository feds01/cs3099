...
export const useDeletePublicationUsernameNameRevision = <TError = ApiErrorResponse, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
 ...
 */
export const getPublicationUsernameNameRevisionAll = (username: string, name: string, revision: string) => {
...
export const getGetPublicationUsernameNameRevisionAllQueryKey = (username: string, name: string, revision: string) => [
    `/publication/${username}/${name}/${revision}/all`,
];

export const useGetPublicationUsernameNameRevisionAll = <
    TData = AsyncReturnType<typeof getPublicationUsernameNameRevisionAll>,
    TError = ApiErrorResponse
>(
    username: string,
    name: string,
    revision: string,
    options?: { query?: UseQueryOptions<AsyncReturnType<typeof getPublicationUsernameNameRevisionAll>, TError, TData> },
) => {
    const { query: queryOptions } = options || {};

    const queryKey =
        queryOptions?.queryKey ?? getGetPublicationUsernameNameRevisionAllQueryKey(username, name, revision);
    const queryFn: QueryFunction<AsyncReturnType<typeof getPublicationUsernameNameRevisionAll>> = () =>
        getPublicationUsernameNameRevisionAll(username, name, revision);

    const query = useQuery<AsyncReturnType<typeof getPublicationUsernameNameRevisionAll>, TError, TData>(
        queryKey,
        queryFn,
        { enabled: !!(username && name && revision), ...queryOptions },
    );
 ...
 */
export const postPublicationUsernameNameRevisionExport = (username: string, name: string, revision: string) => {
    return customInstance<NoContentResponse>({
        url: `/publication/${username}/${name}/${revision}/export`,
        method: 'post',
        data: undefined,
    });
};

export const usePostPublicationUsernameNameRevisionExport = <TError = ApiErrorResponse, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
        AsyncReturnType<typeof postPublicationUsernameNameRevisionExport>,
        TError,
        { username: string; name: string; revision: string },
        TContext
    >;
