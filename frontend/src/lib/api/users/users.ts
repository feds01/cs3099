...
export const deleteUserUsername = (username: string) => {
    return customInstance<ApiSuccessResponse>({ url: `/user/${username}`, method: 'delete' });
};
 ...
 */
export const deleteUserUsernameAvatar = (username: string) => {
    return customInstance<ApiSuccessResponse>({ url: `/user/${username}/avatar`, method: 'delete' });
};

export const useDeleteUserUsernameAvatar = <TError = ApiErrorResponse, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
        AsyncReturnType<typeof deleteUserUsernameAvatar>,
        TError,
        { username: string },
        TContext
    >;
    ...
    const mutationFn: MutationFunction<AsyncReturnType<typeof deleteUserUsernameAvatar>, { username: string }> = (
        props,
    ) => {
        const { username } = props || {};
    ...
    return useMutation<AsyncReturnType<typeof deleteUserUsernameAvatar>, TError, { username: string }, TContext>(
        mutationFn,
        mutationOptions,
    );
};
 ...
 */
export const getUserUsernameAvatar = (username: string) => {
    return customInstance<Blob>({ url: `/user/${username}/avatar`, method: 'get', responseType: 'blob' });
};

export const getGetUserUsernameAvatarQueryKey = (username: string) => [`/user/${username}/avatar`];

export const useGetUserUsernameAvatar = <
    TData = AsyncReturnType<typeof getUserUsernameAvatar>,
    TError = ApiErrorResponse,
>(
    username: string,
    options?: { query?: UseQueryOptions<AsyncReturnType<typeof getUserUsernameAvatar>, TError, TData> },
): UseQueryResult<TData, TError> & { queryKey: QueryKey } => {
    const { query: queryOptions } = options || {};
    ...
    const query = useQuery<AsyncReturnType<typeof getUserUsernameAvatar>, TError, TData>(queryKey, queryFn, {
        enabled: !!username,
        ...queryOptions,
    });
