...
export const getGetUserUsernameRoleMock = () => ({status: faker.helpers.randomize(Object.values(SuccessStatus)), role: faker.random.word()})

export const getPatchUserUsernameRoleMock = () => ({status: faker.helpers.randomize(Object.values(SuccessStatus)), role: faker.random.word()})

export const getPostUserUsernameFollowMock = () => ({status: faker.helpers.randomize(Object.values(SuccessStatus))})

export const getDeleteUserUsernameFollowMock = () => ({status: faker.helpers.randomize(Object.values(SuccessStatus))})
