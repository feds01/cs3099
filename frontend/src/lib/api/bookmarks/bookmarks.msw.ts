...
export const getGetPublicationUsernameNameBookmarkMock = () => ({
    status: faker.helpers.randomize(['ok']),
    bookmarked: faker.datatype.boolean(),
});

export const getGetPublicationUsernameNameBookmarkersMock = () => ({
    status: faker.helpers.randomize(['ok']),
    bookmarks: [...Array(faker.datatype.number({ min: 1, max: 10 }))].map(() => ({
...
export const getGetPublicationUsernameBookmarksMock = () => ({
    status: faker.helpers.randomize(['ok']),
    bookmarked: faker.helpers.randomize([
