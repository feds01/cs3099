...
export const useGetVersion = <TData = AsyncReturnType<typeof getVersion>, TError = unknown>(
  options?: { query?:UseQueryOptions<AsyncReturnType<typeof getVersion>, TError, TData>, }
...
export const getOpenapi = (
      ...
      return customInstance<GetOpenapi200>(
      {url: `/openapi`, method: 'get'
    },
      );
    }
...
export const useGetOpenapi = <TData = AsyncReturnType<typeof getOpenapi>, TError = unknown>(
  options?: { query?:UseQueryOptions<AsyncReturnType<typeof getOpenapi>, TError, TData>, }
