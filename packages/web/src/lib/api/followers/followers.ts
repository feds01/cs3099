 ...
 */
export const getUserUsernameFollowers = (username: string, params?: GetUserUsernameFollowersParams) => {
    return customInstance<FollowerListResponse>({ url: `/user/${username}/followers`, method: 'get', params });
};

export const getGetUserUsernameFollowersQueryKey = (username: string, params?: GetUserUsernameFollowersParams) => [
...
>(
    ...
    const queryFn: QueryFunction<AsyncReturnType<typeof getUserUsernameFollowers>> = () =>
        getUserUsernameFollowers(username, params);
 ...
 */
export const getUserUsernameFollowing = (username: string, params?: GetUserUsernameFollowingParams) => {
    return customInstance<FollowerListResponse>({ url: `/user/${username}/following`, method: 'get', params });
};

export const getGetUserUsernameFollowingQueryKey = (username: string, params?: GetUserUsernameFollowingParams) => [
...
>(
    ...
    const queryFn: QueryFunction<AsyncReturnType<typeof getUserUsernameFollowing>> = () =>
        getUserUsernameFollowing(username, params);
